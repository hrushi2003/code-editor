...
const SendChanges = (data) => {
    console.log("members array length is ", members.length)
    console.log(Array.isArray(members))
    membersRef.current?.filter(x => x._id !== userId).forEach((member, indx) => {
        console.log(member._id, "is the member changing the data and the data is ", data);
